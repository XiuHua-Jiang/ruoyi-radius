package com.ruoyi.radius.toughradius.config;
...
import com.ruoyi.radius.toughradius.common.DefaultThreadFactory;
import com.ruoyi.radius.toughradius.portal.handler.AcSimHandler;
import com.ruoyi.radius.toughradius.portal.handler.PortalHandler;
...
@Configuration
@PropertySource(value = "classpath:conf/radius-application.properties")
