...
public class SubscribeCache {
    ...
    public Subscribe createTempSubscribe(String username, String password, int days){
        ...
        subscribe.setId(CoderUtil.randomLong15Id());
        ...
        subscribe.setUpRate(10L);
        subscribe.setDownRate(10L);
        subscribe.setUpPeakRate(10L);
        subscribe.setDownPeakRate(10L);
    ...
    public Subscribe createTempSubscribe(String username, String password,String macAddr, long seconds,int activeNum){
    	Subscribe subscribe = new Subscribe();
    	subscribe.setId(CoderUtil.randomLong15Id());
    	subscribe.setSubscriber(username);
    	subscribe.setPassword(password);
    	subscribe.setNodeId(0L);
    	subscribe.setRealname(StringUtils.isEmpty(macAddr)? "" : "临时用户");
    	subscribe.setDomain("wlan");
    	subscribe.setAddrPool("");
    	subscribe.setPolicy("");
    	subscribe.setIsOnline(0);
    	subscribe.setActiveNum(activeNum);
    	subscribe.setBindMac(0);
    	subscribe.setBindVlan(0);
    	subscribe.setIpAddr("");
    	subscribe.setMacAddr(macAddr);
    	subscribe.setInVlan(0);
    	subscribe.setOutVlan(0);
    	subscribe.setUpRate(20L);
        subscribe.setDownRate(20L);
        subscribe.setUpPeakRate(100L);
        subscribe.setDownPeakRate(100L);
    	subscribe.setUpRateCode("");
    	subscribe.setDownRateCode("");
    	subscribe.setStatus("enabled");
    	subscribe.setBeginTime(DateTimeUtil.nowTimestamp());
    	...
    	subscribe.setCreateTime(DateTimeUtil.nowTimestamp());
    	subscribe.setUpdateTime(DateTimeUtil.nowTimestamp());
    	subscribe.setRemark(StringUtils.isEmpty(macAddr)? "" : "临时用户");
    	return subscribe;
    }
